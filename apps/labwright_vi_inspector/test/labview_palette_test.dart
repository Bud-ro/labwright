...
void main() {
  test('terminals keep LabVIEW datatype colors (orange float, blue int/enum)', () {
    expect(labviewTypeColor(ViTypeKind.numericFloat), const Color(0xFFFF8000));
    ...
    expect(labviewTypeColor(ViTypeKind.unknown), const Color(0xFF8A8A8A),
