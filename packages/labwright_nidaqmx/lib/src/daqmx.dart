...
//                       it throws [UnimplementedError] (NI ships no macOS runtime),
...
abstract final class Daqmx {
  ...
  ///
  /// On macOS this throws [UnimplementedError]: there is no local NI-DAQmx runtime
  /// for macOS, so a local connection is impossible — use [remote] against a host
  /// running the NI gRPC Device Server.
  ...
  static DaqmxApi remote({
    ...
    bool secure = false,
      ...
      GrpcDaqmxBackend(host: host, port: port, secure: secure);
}
