...
typedef _CfgSampClkTimingC = Int32 Function(TaskHandle, Pointer<Utf8>, Double, Int32, Int32, Uint64);
typedef _CfgInputBufferC = Int32 Function(TaskHandle, Uint32);
typedef _ReadAnalogF64C =
    Int32 Function(TaskHandle, Int32, Double, Uint32, Pointer<Double>, Uint32, Pointer<Int32>, Pointer<Uint32>);
...
typedef _ReadBinaryI16C =
    Int32 Function(TaskHandle, Int32, Double, Uint32, Pointer<Int16>, Uint32, Pointer<Int32>, Pointer<Uint32>);
typedef _ReadBinaryI32C =
    Int32 Function(TaskHandle, Int32, Double, Uint32, Pointer<Int32>, Uint32, Pointer<Int32>, Pointer<Uint32>);
typedef _ReadBinaryU16C =
    Int32 Function(TaskHandle, Int32, Double, Uint32, Pointer<Uint16>, Uint32, Pointer<Int32>, Pointer<Uint32>);
typedef _ReadBinaryU32C =
    Int32 Function(TaskHandle, Int32, Double, Uint32, Pointer<Uint32>, Uint32, Pointer<Int32>, Pointer<Uint32>);
...
class NidaqmxBindings {
  NidaqmxBindings(DynamicLibrary lib)
    : createTask = lib.lookupFunction<_CreateTaskC, _CreateTaskDart>('DAQmxCreateTask'),
      ...
      createAIVoltageChan = lib.lookupFunction<_CreateAiVoltageC, _CreateAiVoltageDart>('DAQmxCreateAIVoltageChan'),
      createAOVoltageChan = lib.lookupFunction<_CreateAoVoltageC, _CreateAoVoltageDart>('DAQmxCreateAOVoltageChan'),
      cfgSampClkTiming = lib.lookupFunction<_CfgSampClkTimingC, _CfgSampClkTimingDart>('DAQmxCfgSampClkTiming'),
      cfgInputBuffer = lib.lookupFunction<_CfgInputBufferC, _CfgInputBufferDart>('DAQmxCfgInputBuffer'),
      ...
      readAnalogScalarF64 = lib.lookupFunction<_ReadAnalogScalarF64C, _ReadAnalogScalarF64Dart>(
        'DAQmxReadAnalogScalarF64',
      ),
      writeAnalogScalarF64 = lib.lookupFunction<_WriteAnalogScalarF64C, _WriteAnalogScalarF64Dart>(
        'DAQmxWriteAnalogScalarF64',
      ),
      getExtendedErrorInfo = lib.lookupFunction<_GetStringC, _GetStringDart>('DAQmxGetExtendedErrorInfo'),
  ...
  createAIVoltageChan;
  final int Function(TaskHandle, Pointer<Utf8>, Pointer<Utf8>, double, double, int, Pointer<Utf8>) createAOVoltageChan;
  ...
  final int Function(TaskHandle, int, double, int, Pointer<Double>, int, Pointer<Int32>, Pointer<Uint32>) readAnalogF64;
  final int Function(TaskHandle, int, double, int, Pointer<Int16>, int, Pointer<Int32>, Pointer<Uint32>) readBinaryI16;
  final int Function(TaskHandle, int, double, int, Pointer<Int32>, int, Pointer<Int32>, Pointer<Uint32>) readBinaryI32;
  final int Function(TaskHandle, int, double, int, Pointer<Uint16>, int, Pointer<Int32>, Pointer<Uint32>) readBinaryU16;
  final int Function(TaskHandle, int, double, int, Pointer<Uint32>, int, Pointer<Int32>, Pointer<Uint32>) readBinaryU32;
...
typedef _ReadAnalogF64Dart =
    int Function(TaskHandle, int, double, int, Pointer<Double>, int, Pointer<Int32>, Pointer<Uint32>);
typedef _ReadBinaryI16Dart =
    int Function(TaskHandle, int, double, int, Pointer<Int16>, int, Pointer<Int32>, Pointer<Uint32>);
typedef _ReadBinaryI32Dart =
    int Function(TaskHandle, int, double, int, Pointer<Int32>, int, Pointer<Int32>, Pointer<Uint32>);
typedef _ReadBinaryU16Dart =
    int Function(TaskHandle, int, double, int, Pointer<Uint16>, int, Pointer<Int32>, Pointer<Uint32>);
typedef _ReadBinaryU32Dart =
    int Function(TaskHandle, int, double, int, Pointer<Uint32>, int, Pointer<Int32>, Pointer<Uint32>);
