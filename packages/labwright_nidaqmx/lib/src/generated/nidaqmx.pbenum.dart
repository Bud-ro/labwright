...
class InputTermCfgWithDefault extends $pb.ProtobufEnum {
  static const InputTermCfgWithDefault INPUT_TERM_CFG_WITH_DEFAULT_UNSPECIFIED =
      InputTermCfgWithDefault._(
          0, _omitEnumNames ? '' : 'INPUT_TERM_CFG_WITH_DEFAULT_UNSPECIFIED');
  static const InputTermCfgWithDefault INPUT_TERM_CFG_WITH_DEFAULT_CFG_DEFAULT =
      InputTermCfgWithDefault._(
          -1, _omitEnumNames ? '' : 'INPUT_TERM_CFG_WITH_DEFAULT_CFG_DEFAULT');
  static const InputTermCfgWithDefault INPUT_TERM_CFG_WITH_DEFAULT_RSE =
      InputTermCfgWithDefault._(
          10083, _omitEnumNames ? '' : 'INPUT_TERM_CFG_WITH_DEFAULT_RSE');
  static const InputTermCfgWithDefault INPUT_TERM_CFG_WITH_DEFAULT_NRSE =
      InputTermCfgWithDefault._(
          10078, _omitEnumNames ? '' : 'INPUT_TERM_CFG_WITH_DEFAULT_NRSE');
  static const InputTermCfgWithDefault INPUT_TERM_CFG_WITH_DEFAULT_DIFF =
      InputTermCfgWithDefault._(
          10106, _omitEnumNames ? '' : 'INPUT_TERM_CFG_WITH_DEFAULT_DIFF');
  static const InputTermCfgWithDefault INPUT_TERM_CFG_WITH_DEFAULT_PSEUDO_DIFF =
      InputTermCfgWithDefault._(12529,
          _omitEnumNames ? '' : 'INPUT_TERM_CFG_WITH_DEFAULT_PSEUDO_DIFF');

  static const $core.List<InputTermCfgWithDefault> values =
  ...
  static final $core.Map<$core.int, InputTermCfgWithDefault> _byValue =
...
class VoltageUnits2 extends $pb.ProtobufEnum {
  ...
  static const VoltageUnits2 VOLTAGE_UNITS2_FROM_CUSTOM_SCALE = VoltageUnits2._(
      10065, _omitEnumNames ? '' : 'VOLTAGE_UNITS2_FROM_CUSTOM_SCALE');
  ...
  static final $core.Map<$core.int, VoltageUnits2> _byValue =
      $pb.ProtobufEnum.initByValue(values);
