...
final $typed_data.Uint8List inputTermCfgWithDefaultDescriptor =
    $convert.base64Decode('ChdJbnB1dFRlcm1DZmdXaXRoRGVmYXVsdBIrCidJTlBVVF9URVJNX0NGR19XSVRIX0RFRkFVTF'
...
final $typed_data.Uint8List voltageUnits2Descriptor =
    $convert.base64Decode('Cg1Wb2x0YWdlVW5pdHMyEh4KGlZPTFRBR0VfVU5JVFMyX1VOU1BFQ0lGSUVEEAASGQoUVk9MVE'
...
final $typed_data.Uint8List createTaskRequestDescriptor =
    $convert.base64Decode('ChFDcmVhdGVUYXNrUmVxdWVzdBIhCgxzZXNzaW9uX25hbWUYASABKAlSC3Nlc3Npb25OYW1lEm'
...
const CreateTaskResponse$json = {
  ...
  '2': [
    ...
    {'1': 'task', '3': 2, '4': 1, '5': 11, '6': '.nidevice_grpc.Session', '10': 'task'},
    {'1': 'new_session_initialized', '3': 3, '4': 1, '5': 8, '10': 'newSessionInitialized'},
  ],
};
...
final $typed_data.Uint8List createTaskResponseDescriptor =
    $convert.base64Decode('ChJDcmVhdGVUYXNrUmVzcG9uc2USFgoGc3RhdHVzGAEgASgFUgZzdGF0dXMSKgoEdGFzaxgCIA'
...
const CreateAIVoltageChanRequest$json = {
  ...
  '2': [
    {'1': 'task', '3': 1, '4': 1, '5': 11, '6': '.nidevice_grpc.Session', '10': 'task'},
    {'1': 'physical_channel', '3': 2, '4': 1, '5': 9, '10': 'physicalChannel'},
    {'1': 'name_to_assign_to_channel', '3': 3, '4': 1, '5': 9, '10': 'nameToAssignToChannel'},
    {
      '1': 'terminal_config',
      '3': 4,
      '4': 1,
    ...
    {'1': 'terminal_config_raw', '3': 5, '4': 1, '5': 5, '9': 0, '10': 'terminalConfigRaw'},
    {'1': 'min_val', '3': 6, '4': 1, '5': 1, '10': 'minVal'},
    {'1': 'max_val', '3': 7, '4': 1, '5': 1, '10': 'maxVal'},
    {'1': 'units', '3': 8, '4': 1, '5': 14, '6': '.nidaqmx_grpc.VoltageUnits2', '9': 1, '10': 'units'},
    {'1': 'units_raw', '3': 9, '4': 1, '5': 5, '9': 1, '10': 'unitsRaw'},
    {'1': 'custom_scale_name', '3': 10, '4': 1, '5': 9, '10': 'customScaleName'},
  ],
  '8': [
...
final $typed_data.Uint8List createAIVoltageChanRequestDescriptor =
    $convert.base64Decode('ChpDcmVhdGVBSVZvbHRhZ2VDaGFuUmVxdWVzdBIqCgR0YXNrGAEgASgLMhYubmlkZXZpY2VfZ3'
...
final $typed_data.Uint8List createAIVoltageChanResponseDescriptor =
    $convert.base64Decode('ChtDcmVhdGVBSVZvbHRhZ2VDaGFuUmVzcG9uc2USFgoGc3RhdHVzGAEgASgFUgZzdGF0dXM=');
...
const CreateAOVoltageChanRequest$json = {
  ...
  '2': [
    ...
    {'1': 'units', '3': 6, '4': 1, '5': 14, '6': '.nidaqmx_grpc.VoltageUnits2', '9': 0, '10': 'units'},
...
final $typed_data.Uint8List createAOVoltageChanRequestDescriptor =
    $convert.base64Decode('ChpDcmVhdGVBT1ZvbHRhZ2VDaGFuUmVxdWVzdBIqCgR0YXNrGAEgASgLMhYubmlkZXZpY2VfZ3'
        'JwYy5TZXNzaW9uUgR0YXNrEikKEHBoeXNpY2FsX2NoYW5uZWwYAiABKAlSD3BoeXNpY2FsQ2hh'
        'bm5lbBI4ChluYW1lX3RvX2Fzc2lnbl90b19jaGFubmVsGAMgASgJUhVuYW1lVG9Bc3NpZ25Ub0'
...
final $typed_data.Uint8List createAOVoltageChanResponseDescriptor =
    $convert.base64Decode('ChtDcmVhdGVBT1ZvbHRhZ2VDaGFuUmVzcG9uc2USFgoGc3RhdHVzGAEgASgFUgZzdGF0dXM=');
...
final $typed_data.Uint8List startTaskRequestDescriptor =
    $convert.base64Decode('ChBTdGFydFRhc2tSZXF1ZXN0EioKBHRhc2sYASABKAsyFi5uaWRldmljZV9ncnBjLlNlc3Npb2'
        '5SBHRhc2s=');
...
final $typed_data.Uint8List startTaskResponseDescriptor =
    $convert.base64Decode('ChFTdGFydFRhc2tSZXNwb25zZRIWCgZzdGF0dXMYASABKAVSBnN0YXR1cw==');
...
final $typed_data.Uint8List stopTaskRequestDescriptor =
    $convert.base64Decode('Cg9TdG9wVGFza1JlcXVlc3QSKgoEdGFzaxgBIAEoCzIWLm5pZGV2aWNlX2dycGMuU2Vzc2lvbl'
        'IEdGFzaw==');
...
final $typed_data.Uint8List stopTaskResponseDescriptor =
    $convert.base64Decode('ChBTdG9wVGFza1Jlc3BvbnNlEhYKBnN0YXR1cxgBIAEoBVIGc3RhdHVz');
...
final $typed_data.Uint8List clearTaskRequestDescriptor =
    $convert.base64Decode('ChBDbGVhclRhc2tSZXF1ZXN0EioKBHRhc2sYASABKAsyFi5uaWRldmljZV9ncnBjLlNlc3Npb2'
        '5SBHRhc2s=');
...
final $typed_data.Uint8List clearTaskResponseDescriptor =
    $convert.base64Decode('ChFDbGVhclRhc2tSZXNwb25zZRIWCgZzdGF0dXMYASABKAVSBnN0YXR1cw==');
...
final $typed_data.Uint8List readAnalogScalarF64RequestDescriptor =
    $convert.base64Decode('ChpSZWFkQW5hbG9nU2NhbGFyRjY0UmVxdWVzdBIqCgR0YXNrGAEgASgLMhYubmlkZXZpY2VfZ3'
...
final $typed_data.Uint8List readAnalogScalarF64ResponseDescriptor =
    $convert.base64Decode('ChtSZWFkQW5hbG9nU2NhbGFyRjY0UmVzcG9uc2USFgoGc3RhdHVzGAEgASgFUgZzdGF0dXMSFA'
...
final $typed_data.Uint8List writeAnalogScalarF64RequestDescriptor =
    $convert.base64Decode('ChtXcml0ZUFuYWxvZ1NjYWxhckY2NFJlcXVlc3QSKgoEdGFzaxgBIAEoCzIWLm5pZGV2aWNlX2'
...
final $typed_data.Uint8List writeAnalogScalarF64ResponseDescriptor =
    $convert.base64Decode('ChxXcml0ZUFuYWxvZ1NjYWxhckY2NFJlc3BvbnNlEhYKBnN0YXR1cxgBIAEoBVIGc3RhdHVz');
...
final $typed_data.Uint8List getErrorStringRequestDescriptor =
    $convert.base64Decode('ChVHZXRFcnJvclN0cmluZ1JlcXVlc3QSHQoKZXJyb3JfY29kZRgBIAEoBVIJZXJyb3JDb2Rl');
...
final $typed_data.Uint8List getErrorStringResponseDescriptor =
    $convert.base64Decode('ChZHZXRFcnJvclN0cmluZ1Jlc3BvbnNlEhYKBnN0YXR1cxgBIAEoBVIGc3RhdHVzEiEKDGVycm'
...
final $typed_data.Uint8List cfgSampClkTimingRequestDescriptor =
    $convert.base64Decode('ChdDZmdTYW1wQ2xrVGltaW5nUmVxdWVzdBIqCgR0YXNrGAEgASgLMhYubmlkZXZpY2VfZ3JwYy'
...
final $typed_data.Uint8List cfgSampClkTimingResponseDescriptor =
    $convert.base64Decode('ChhDZmdTYW1wQ2xrVGltaW5nUmVzcG9uc2USFgoGc3RhdHVzGAEgASgFUgZzdGF0dXM=');
...
const BeginReadAnalogF64Request$json = {
  ...
  '2': [
    {'1': 'task', '3': 1, '4': 1, '5': 11, '6': '.nidevice_grpc.Session', '10': 'task'},
    {'1': 'num_samps_per_chan', '3': 2, '4': 1, '5': 5, '10': 'numSampsPerChan'},
    {'1': 'timeout', '3': 3, '4': 1, '5': 1, '10': 'timeout'},
    {'1': 'fill_mode_raw', '3': 5, '4': 1, '5': 5, '10': 'fillModeRaw'},
    {'1': 'array_size_in_samps', '3': 6, '4': 1, '5': 13, '10': 'arraySizeInSamps'},
  ],
};

/// Descriptor for `BeginReadAnalogF64Request`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List beginReadAnalogF64RequestDescriptor =
    $convert.base64Decode('ChlCZWdpblJlYWRBbmFsb2dGNjRSZXF1ZXN0EioKBHRhc2sYASABKAsyFi5uaWRldmljZV9ncn'
...
const BeginReadAnalogF64Response$json = {
  ...
  '2': [
    {'1': 'status', '3': 1, '4': 1, '5': 5, '10': 'status'},
    {'1': 'moniker', '3': 2, '4': 1, '5': 11, '6': '.ni.data_monikers.Moniker', '10': 'moniker'},
  ],
};
...
final $typed_data.Uint8List beginReadAnalogF64ResponseDescriptor =
    $convert.base64Decode('ChpCZWdpblJlYWRBbmFsb2dGNjRSZXNwb25zZRIWCgZzdGF0dXMYASABKAVSBnN0YXR1cxIzCg'
...
final $typed_data.Uint8List beginReadBinaryI16RequestDescriptor =
    $convert.base64Decode('ChlCZWdpblJlYWRCaW5hcnlJMTZSZXF1ZXN0EioKBHRhc2sYASABKAsyFi5uaWRldmljZV9ncn'
        'BjLlNlc3Npb25SBHRhc2sSKwoSbnVtX3NhbXBzX3Blcl9jaGFuGAIgASgFUg9udW1TYW1wc1Bl'
        'ckNoYW4SGAoHdGltZW91dBgDIAEoAVIHdGltZW91dBIiCg1maWxsX21vZGVfcmF3GAUgASgFUg'
        'tmaWxsTW9kZVJhdxItChNhcnJheV9zaXplX2luX3NhbXBzGAYgASgNUhBhcnJheVNpemVJblNh'
        'bXBz');
...
final $typed_data.Uint8List beginReadBinaryI16ResponseDescriptor =
    $convert.base64Decode('ChpCZWdpblJlYWRCaW5hcnlJMTZSZXNwb25zZRIWCgZzdGF0dXMYASABKAVSBnN0YXR1cxIzCg'
        'dtb25pa2VyGAIgASgLMhkubmkuZGF0YV9tb25pa2Vycy5Nb25pa2VyUgdtb25pa2Vy');
...
final $typed_data.Uint8List beginReadBinaryI32RequestDescriptor =
    $convert.base64Decode('ChlCZWdpblJlYWRCaW5hcnlJMzJSZXF1ZXN0EioKBHRhc2sYASABKAsyFi5uaWRldmljZV9ncn'
        'BjLlNlc3Npb25SBHRhc2sSKwoSbnVtX3NhbXBzX3Blcl9jaGFuGAIgASgFUg9udW1TYW1wc1Bl'
        'ckNoYW4SGAoHdGltZW91dBgDIAEoAVIHdGltZW91dBIiCg1maWxsX21vZGVfcmF3GAUgASgFUg'
        'tmaWxsTW9kZVJhdxItChNhcnJheV9zaXplX2luX3NhbXBzGAYgASgNUhBhcnJheVNpemVJblNh'
        'bXBz');
...
final $typed_data.Uint8List beginReadBinaryI32ResponseDescriptor =
    $convert.base64Decode('ChpCZWdpblJlYWRCaW5hcnlJMzJSZXNwb25zZRIWCgZzdGF0dXMYASABKAVSBnN0YXR1cxIzCg'
        'dtb25pa2VyGAIgASgLMhkubmkuZGF0YV9tb25pa2Vycy5Nb25pa2VyUgdtb25pa2Vy');
...
const MonikerReadAnalogF64Response$json = {
  ...
  '2': [
    ...
    {'1': 'samps_per_chan_read', '3': 3, '4': 1, '5': 5, '10': 'sampsPerChanRead'},
  ],
};
...
final $typed_data.Uint8List monikerReadAnalogF64ResponseDescriptor =
    $convert.base64Decode('ChxNb25pa2VyUmVhZEFuYWxvZ0Y2NFJlc3BvbnNlEhYKBnN0YXR1cxgBIAEoBVIGc3RhdHVzEh'
...
final $typed_data.Uint8List monikerReadBinaryI16ResponseDescriptor =
    $convert.base64Decode('ChxNb25pa2VyUmVhZEJpbmFyeUkxNlJlc3BvbnNlEhYKBnN0YXR1cxgBIAEoBVIGc3RhdHVzEh'
...
final $typed_data.Uint8List monikerReadBinaryI32ResponseDescriptor =
    $convert.base64Decode('ChxNb25pa2VyUmVhZEJpbmFyeUkzMlJlc3BvbnNlEhYKBnN0YXR1cxgBIAEoBVIGc3RhdHVzEh'
        '0KCnJlYWRfYXJyYXkYAiADKAVSCXJlYWRBcnJheRItChNzYW1wc19wZXJfY2hhbl9yZWFkGAMg'
        'ASgFUhBzYW1wc1BlckNoYW5SZWFk');
