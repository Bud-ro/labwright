...
enum BlockTag {
  ...
  fptd('FPTD', 'Front-panel type descriptors', BlockCategory.typeInfo, BlockConfidence.likely, decodeU16Grid),
  ...
  cpd2('CPD2', 'Connector-pane data v2', BlockCategory.connectorPane, BlockConfidence.likely, decodeCpd2Record),
  ...
  picc('PICC', 'Icon placement', BlockCategory.icon, BlockConfidence.confirmed, decodeIconPlacement),
  ...
  lpin('LPIN', 'Linked-instance info', BlockCategory.linkInfo, BlockConfidence.tentative, decodeWordGrid),
  ...
  lvsr('LVSR', 'LabVIEW save record', BlockCategory.settings, BlockConfidence.confirmed, decodeSaveRecord),

  /// Version record in the Mac `vers` layout: numeric version plus short and long version strings.
  vers('vers', 'Version record', BlockCategory.settings, BlockConfidence.confirmed, decodeVersBlock),
  ...
  bdpw('BDPW', 'Block-diagram password', BlockCategory.security, BlockConfidence.confirmed, decodePasswordRecord),
  ...
  hist('HIST', 'Revision history', BlockCategory.history, BlockConfidence.confirmed, decodeHistory),

  /// Modified UID, one u32.
  muid('MUID', 'Modified UID', BlockCategory.identifier, BlockConfidence.confirmed, decodeModifiedUid),
  ...
  rtsg('RTSG', 'Run-time signature', BlockCategory.identifier, BlockConfidence.confirmed, decodeRuntimeSignature),

  /// Object signature, a 16-byte digest.
  obsg('OBSG', 'Object signature', BlockCategory.identifier, BlockConfidence.confirmed, decodeRuntimeSignature),

  /// Compiled-code signature, a 16-byte digest.
  ccsg('CCSG', 'Compiled-code signature', BlockCategory.identifier, BlockConfidence.confirmed, decodeRuntimeSignature),

  /// Source signature: a marker word and a 16-byte digest.
  scsr('SCSR', 'Source signature', BlockCategory.identifier, BlockConfidence.confirmed, decodeScsrRecord),

  /// Generated-code property record.
  gcpr('GCPR', 'Generated-code property', BlockCategory.identifier, BlockConfidence.confirmed, decodeGcprRecord),
  ...
  fpse('FPSE', 'Front-panel section entry', BlockCategory.unknown, BlockConfidence.confirmed, decodeSectionMarker),

  /// Block-diagram section entry: one or two u32 words.
  bdse('BDSE', 'Block-diagram section entry', BlockCategory.unknown, BlockConfidence.confirmed, decodeSectionMarker),

  /// Front-panel extended state words.
  fpex('FPEx', 'Front-panel extended state', BlockCategory.unknown, BlockConfidence.confirmed, decodeExtendedState),

  /// Block-diagram extended state words.
  bdex('BDEx', 'Block-diagram extended state', BlockCategory.unknown, BlockConfidence.confirmed, decodeExtendedState),
  ...
  bdts('BDTS', 'Block-diagram TS', BlockCategory.unknown, BlockConfidence.tentative, decodeWordGrid),

  /// VI property data record.
  vpdp('VPDP', 'VI property data', BlockCategory.unknown, BlockConfidence.confirmed, decodeVpdpRecord),

  /// Print settings record.
  prt('PRT ', 'Print settings', BlockCategory.unknown, BlockConfidence.confirmed, decodePrintRecord),

  /// Default-data loader record, seven u32 words.
  dldr('DLDR', 'Default-data loader', BlockCategory.unknown, BlockConfidence.confirmed, decodeDldrRecord),
  ...
  cnst('CNST', 'Constants', BlockCategory.unknown, BlockConfidence.tentative, decodeWordGrid),
  ...
  cout('COUT', 'Compiled output', BlockCategory.unknown, BlockConfidence.likely, decodeCoutRecord),
  ...
  const BlockTag(this.tag, this.displayName, this.category, this.confidence, [this.decode]);
