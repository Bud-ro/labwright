...
void main(List<String> args) {
  ...
  for (final src in bySource.keys.toList()..sort()) {
    ...
    md.writeln('| $src | ${s.vis} | ${s.parseOk} | ${s.decOk} | ${s.objVIs} | ${s.heaps} | '
  ...
  if (rootDir.existsSync()) {
    final report = StringBuffer()
      ...
      ..writeln()
      ..writeln('Auto-generated by `packages/labwright_vi_parse/tool/coverage.dart` '
      ...
      ..writeln()
      ..writeln('**TOTAL** ${overall.vis} VIs · parse '
  ...
  if (pico.existsSync()) {
    ...
    final baseline = {
      'generatedBy': 'packages/labwright_vi_parse/tool/coverage.dart',
