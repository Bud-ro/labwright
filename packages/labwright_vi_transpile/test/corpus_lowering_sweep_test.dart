...
const Map<String, int> kCorpusLoweringSweep = {
  ...
  'clus.kid.none': 21537,
  'clus.kid.one': 69008,
  'clus.kidAgrees': 45000,
  'clus.kidDisagrees': 24008,
  'clus.kidNameOnly': 23621,
  'clus.many': 1372,
  'clus.none': 41095,
  'clus.noneNoIndex': 42,
  ...
  'clus.pane.none': 4215,
  'clus.pane.one': 6326,
  'clus.paneAgrees': 2653,
  'clus.paneDisagrees': 3673,
  'clus.paneNameOnly': 3628,
  'clus.typedefContradicts': 6,
  'clus.viaTypedef': 18114,
  'clus.why.member.0x33': 281,
  'clus.why.member.0x54': 1809,
  'clus.why.member.0xd': 4,
  'clus.why.noneNoCluster': 40662,
  'clus.why.noneNoIndex': 42,
  'clus.why.noneUntyped': 391,
  'clus.why.typed': 89760,
  'clus.why.typesDisagree': 157,
  'clusType.kidAgrees': 68146,
  'clusType.kidChecked': 5646,
  'clusType.kidDisagrees': 1931,
  'clusType.kidLabelOnly': 1866,
  'clusType.kidShapeDiffers': 65,
  'clusType.kidUnchecked': 32631,
  'clusType.kidWouldDecide': 38277,
...
int? _refnumDims(ViHeapObject object) {
  ...
  return unwrap(object.resolvedElementType)?.kind == ViDataType.refnum ? own.dimCount : null;
}
